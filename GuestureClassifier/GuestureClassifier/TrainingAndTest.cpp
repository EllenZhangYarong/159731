                                     ...
                                     const string& filename_to_save)
{
    ...
    //    r = model->predict( sample1 );
    //    cout << "Prediction: " << r << endl;
    sample1 = (Mat_<float>(1,19) << 0.424566, 0.12991901, 0.094148003, 0.098379001, 0.035615999, 0.030347001, 0.042470999, 0.015706999, 0.0044499999, 0.022115, 0.011137, 0.027294001, 0.010089, 0.022445999, 0.009873, 0.016189, 0.015598, 0.0073839999, 0.0080289999);//1
    r = model->predict( sample1 );
    cout << "Prediction: " << r << endl;
